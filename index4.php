            ...
            <form class="w-100" action="index4.php" method="post">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6 d-flex flex-column w-lg-50 w-md-75 w-sm-100 ">
                        ...
                        <a class="btn btn-pink my-3 w-100" value="Удалить свои данные из клиентской базы" name="del" data-toggle="collapse" href="#collapse" aria-expanded="false" aria-controls="collapse">Удалить свои данные из клиентской базы</a>
