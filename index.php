...
<div id="carouselExampleIndicators" class="carousel slide w-75 print-none" data-ride="carousel">
  ...
  <div class="carousel-inner print-none" role="listbox">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="img/carousel5.jpg" data-src="holder.js/900x400?theme=industrial" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/carousel4.jpg" data-src="holder.js/900x400?theme=industrial" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/carousel2.jpg" data-src="holder.js/900x400?theme=industrial" alt="Fouth slide">
    </div>
    <div class="carousel-item">
